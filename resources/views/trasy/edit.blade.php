...
<body>
    ...
    <input type="time" name="Godzina_odjazdu" value="{{ old('Godzina_odjazdu', $trasa->Godzina_odjazdu) }}">
</div>
<div>
    <label>Godzina przyjazdu:</label>
    <input type="time" name="Godzina_przyjazdu" value="{{ old('Godzina_przyjazdu', $trasa->Godzina_przyjazdu) }}">
</div>
